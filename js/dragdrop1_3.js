function dragDrop1_3(inputData) {
		...
		function buildModuleContainer() {
			...
			$('<div class="score"></div>').appendTo('.scoreBar')
				...
				for (var k = 0; k < data.drag.length; k++) {
					...
					$('<div id="dragDropImg1_3_' + k + '"class="dragDropImg1_3_"><img src="' + data.drag[k].dropImg + '"/></div>').appendTo('.dragContainer');
					$('#dragDropImg1_3_' + k + '').attr("data", "" + data.drag[k].name + "");
					$('<div id="dragDropName1_3_' + k + '"class="dragDropName1_3_">' + data.drag[k].dropName + ' </div>').appendTo('#dragDropImg1_3_' + k);
					$('#dragDropName1_3_' + k + '').attr("data", "" + data.drag[k].name + "");
