function dragDrop2_1(inputData) {
...
$.getJSON(inputData, function() {
		...
		function buildModuleContainer() {
			...
			$('<div class="dragContainer4"></div>').appendTo('.assignmentContainer2')
			$('<div class="imgContainer2"></div>').appendTo('.assignmentContainer2')
			...
			$('<div class="score"></div>').appendTo('.scoreBar')
				...
				for (var l = 0; l < data.backgroundImg.length; l++) {

					$('<div id="backgroundImg' + l + '"class="backgroundImg"><img src="' + data.backgroundImg[l].img + '"/></div>').appendTo('.dragContainer4');
				...
				for (var k = 0; k < data.drag.length; k++) {
					...
					$('<div id="dragDropName2_1_' + k + '"class="dragDropName2_1_">' + data.drag[k].dropName + ' </div>').appendTo('.dragContainer4');
					$('#dragDropName2_1_' + k + '').attr("data", "" + data.drag[k].name + "");
