function dragDrop1_4(inputData) {
...
$.getJSON(inputData, function() {
		...
		function buildModuleContainer() {
			...
			$('<div class="dragContainer2"></div>').appendTo('.assignmentContainer2')
			$('<div class="dragContainer3"></div>').appendTo('.assignmentContainer2')
			$('<div class="imgContainer"></div>').appendTo('.assignmentContainer2')
			$('<div class="can"><p>can</p></div>').appendTo('.dragContainer2')
			$('<div class="cant"><p>cant</p></div>').appendTo('.dragContainer2')
			$('<div class="iCan"><p>I can play</p></div>').appendTo('.dragContainer3')
			...
			$('<div class="score"></div>').appendTo('.scoreBar')
				...
				for (var i = 0; i < data.characters.length; i++) {
					...
					$('<div id="characters' + i + '"class="characters"><img src="' + data.characters[i].person + '"/> </div>').appendTo('.soundContainer');
				...
				for (var k = 0; k < data.drag.length; k++) {
					...
					$('<div id="dragDropImg1_4_' + k + '"class="dragDropImg1_4_">' + data.drag[k].dropName + '</div>').appendTo('.dragContainer2');
					$('#dragDropImg1_4_' + k + '').attr("data", "" + data.drag[k].img + "");

					

				};

					for (var l = 0; l < data.dragMe.length; l++) {

						$('<div id="dragDropImg1_4_' + (l+8) + '"class="dragDropImg1_4_">' + data.dragMe[l].name + '</div>').appendTo('.dragContainer3');
						$('#dragDropImg1_4_' + (l+8) + '').attr("data", "" + data.dragMe[l].img + "");

					$('<div id="dragName' + (l+8) + '"class="dragName"><img src="' + data.dragMe[l].img + '"/></div>').appendTo('.imgContainer');
					$('#dragName' + (l+8) + '').attr("data", "" + data.dragMe[l].img + "");					
					};


				for (var x = 0; x < data.drag.length; x++) {

				$('<div id="dragName' + x + '"class="dragName"><img src="' + data.drag[x].img + '"/></div>').appendTo('.imgContainer');
				$('#dragName' + x + '').attr("data", "" + data.drag[x].img + "");
		...
		result = Math.round(((count / totalAnswers) * 100) * 10) / 10;
		//checkScore();
		//calculateScore();
